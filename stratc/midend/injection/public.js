// Not compelling enough to make it into the language as-is
// Things that need to be complete before this feature ships:
...
//     traverse(ast, ['file', 'service', 'body', 'dispatch', 'function', 'functionName']),
//     traverse(ast, ['file', 'service', 'body','function', 'functionName'])
//   ].flat()
...
//   const publicFunctions = [
//     traverse(service, ['body', 'function', 'functionName']),
//     traverse(service, ['body', 'dispatch', 'function', 'functionName'])
//   ].flat()
//   .filter(functionIsPublic);

//   if (publicFunctions.length === 0) return;

//   const httpInclude = traverse(service, ['body', 'include'])
...
//   const newAst = await compile('ast', text, 'stub.st');
//   return traverse(newAst, ['service', 'body', 'dispatch'])[0];
// }
